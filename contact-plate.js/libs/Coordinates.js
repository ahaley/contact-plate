/*global THREE scene*/
var Coordinates = {
	drawGrid:function(params, scene) {
		params = params || {};
		...
		var planeGeometry = new THREE.PlaneGeometry(size, size, size * scale, size * scale);
	...
	drawGround:function(params, scene) {
		params = params || {};
		var size = params.size !== undefined ? params.size:100;
	...
	drawAxes:function(params, scene) {
	...
	drawAllAxes:function(params, scene) {
		params = params || {};
		var axisRadius = params.axisRadius !== undefined ? params.axisRadius:0.04;
		var axisLength = params.axisLength !== undefined ? params.axisLength:11;
		var axisTess = params.axisTess !== undefined ? params.axisTess:48;
